  ...
  return {
    ...
    OnceExit(root, {
      ...
      root.walkAtRules(extendMatch, extendAtRule => {
        ...
        if (!extendedAtRules.has(extendAtRule)) {
          ...
          if (extendingRules.length) {
            ...
            extendAtRule.replaceWith(extendingRules); // store parent to process with postcss-nesting later
      ...
      parentsToProcess.forEach(parent => {
        ...
        postcss([(0, _postcssNesting.default)({
          edition: '2021',
      ...
      root.walkRules(functionalSelectorMatch, functionalRule => {
        ...
        if (opts.onFunctionalSelector === 'throw') {
          ...
          const selectors = functionalRule.selectors.filter(selector => selector.charAt(0) !== '%');
...
exports.default = postcssExtendRule;
